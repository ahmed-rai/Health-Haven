...
class PharmacieController extends AbstractController
{
    ...
    #[Route('/Back', name: 'app_pharmacie_indexBack', methods: ['GET'])]
    public function indexBack(EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pharmacie/indexBack.html.twig', [
            'pharmacies' => $pharmacies,
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_pharmacie_indexBack', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('Back/{id}', name: 'app_pharmacie_showBack', methods: ['GET'])]
    public function showBack(Pharmacie $pharmacie): Response
    {
        return $this->render('pharmacie/showBack.html.twig', [
            'pharmacie' => $pharmacie,
        ]);
    }
