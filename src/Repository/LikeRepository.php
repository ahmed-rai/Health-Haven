...
class LikeRepository extends ServiceEntityRepository
{
    ...
    public function findDislike(Conseil $conseils){
...
//            ->setParameter('conseil',$conseil->getIdprod())
//           // ->setParameter('nom','Dislike')
//            ;
//
//        $dislike = $query->getOneOrNullResult();

        $dislike = $this->findOneBy(['nom'=>'Dislikee','conseils'=>$conseils->getId()]);
    ...
    public function findLike(Conseil $conseils){
...
//        $like = $query->getOneOrNullResult();
        ...
        $like = $this->findOneBy(['nom'=>'Likee','conseils'=>$conseils->getId()]);
